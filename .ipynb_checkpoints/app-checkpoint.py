...
# ---------------- Streamlit UI ----------------
st.set_page_config(page_title="SL Data Hasher", page_icon="🔒", layout="centered")
st.title("Data Hasher for Custom Audiences")
st.write("Upload a CSV. The app will normalize and hash the data.")
